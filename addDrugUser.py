...
class Ui_addDrugUser(object):

    def __init__(self):
        global numberValidator,createDate,username
        unix = time.time()
    ...
    def setupUi(self, Dialog):
        ...
        self.drugBTN.setGeometry(QtCore.QRect(330, 310, 221, 41))
    ...
    def addDrug(self):
        ...
        if drugName =="" or reorder=="" or qtn =="" or batchNo=="" or supplier=="" or buyPrice =="" or sellPrice=="":
            ...
            addDrug = ADC.addDrugController.storeDrug(self, drugName, qtn, batchNo, cat, supplier, reorder, expDate, entryDate,
                                            buyPrice, sellPrice, createDate,username)
            if addDrug == "failed":
    ...
    def retranslateUi(self, Dialog):
        ...
        Dialog.setWindowTitle(_translate("Dialog", "Add Drug | SafeDrugs - Pharmacy Management System"))
        ...
        self.label.setText(_translate("Dialog", "Medicine Information "))
